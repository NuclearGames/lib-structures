...
public class NonAllocatedListUnitTests {
    ...
    public void CtorTest(int size) {
        ...
        var stack = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    public void InsertTests(int size, char[] values, bool insertFirst) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
    ...
    public void AddTests(int size, char[] values) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    public void ContainsTests(int size, char[] values, char searchValue, bool expectedResult) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    public void CopyToTests(int size, char[] values, int destSize, int destStartIndex) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    public void RemoveTests(int size, char[] values, char searchValue, bool expectedResult, char[] expectedList) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    [TestCase(5, new char[] { 'A', 'B', 'C', 'D', 'E' })]
    [TestCase(5, new char[] { 'A', 'B', 'C', 'D', 'E', 'F' })]
    public void ClearTests(int size, char[] values) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    [TestCase(5, new char[] { 'A', 'B', 'C', 'D', 'E', 'F' })]
    public void RefGetIndex(int size, char[] values) {
        Span<WrapReadWriteValueType<char>> buffer = stackalloc WrapReadWriteValueType<char>[size];
        var list = new NonAllocatedList<WrapReadWriteValueType<char>>(ref buffer);
    ...
    public void IndexOfTests(int size, char[] values, char searchValue, int expectedResult) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    public void RemoveAtTests(int size, char[] values, int removeAtIndex, int expectedCount) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
    ...
    [TestCase(5, new char[] { 'A', 'B', 'C', 'D', 'E' })]
    [TestCase(5, new char[] { 'A', 'B', 'C', 'D', 'E', 'F' })]
    public void EnumeratorTests(int size, char[] values) {
        Span<WrapReadValueType<char>> buffer = stackalloc WrapReadValueType<char>[size];
        var list = new NonAllocatedList<WrapReadValueType<char>>(ref buffer);
...
#region Utils Actions
    ...
    private void AddInternal<T>(in int size, T[] values, ref NonAllocatedList<WrapReadWriteValueType<T>> list) where T : unmanaged, IComparable<T> {
    ...
    private void AddInternal<T>(in int size, T[] values, ref NonAllocatedList<WrapReadValueType<T>> list) where T : unmanaged, IComparable<T> {
        for (int i = 0; i < values.Length; i++) {
            try {
    ...
    private void InsertInternal<T>(in int size, T[] values, ref NonAllocatedList<WrapReadValueType<T>> list, in bool insertFirst) where T : unmanaged, IComparable<T> {
        for (int i = 0; i < values.Length; i++) {
            try {
                var value = (WrapReadValueType<T>)values[i];
...
#region Utils
    ...
    private readonly record struct WrapReadValueType<T>(T Value) : IComparable<WrapReadValueType<T>> where T : unmanaged, IComparable<T> {
    ...
    private record struct WrapReadWriteValueType<T>(T Value) : IComparable<WrapReadWriteValueType<T>> where T : unmanaged, IComparable<T> {
